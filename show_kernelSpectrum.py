        ...
        def update_visualization(self):
            ...
            if mode == "푸리에 진폭 스펙트럼":
                ...
                for i in range(num_filters):
                    ...
                    if weights_np.shape[1] > 0:
                        ...
                        # 이미지 크기 조정 (16x16을 120x120으로 스케일링)
                        scale_factor = 120 // 16  # 7.5이지만 정수로 7
            ...
            # "실제 가중치" 모드일 경우 - 원본 가중치 그대로 시각화
                ...
                for i in range(num_filters):
                    ...
                    normalized_img = ((filter_img - all_weights_min) / (all_weights_min - all_weights_min + 1e-8) * 255).astype(np.uint8)
